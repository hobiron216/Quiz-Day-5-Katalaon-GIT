...
WebUI.click(findTestObject('Object Repository/Make Appointment Tokyo CURA Healthcare Center/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/Make Appointment Tokyo CURA Healthcare Center/td_17'))

WebUI.setText(findTestObject('Object Repository/Make Appointment Tokyo CURA Healthcare Center/textarea_Comment_comment'), 
    'Test')
