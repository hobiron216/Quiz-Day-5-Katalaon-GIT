...
WebUI.click(findTestObject('Object Repository/Logout/a_Login'))

WebUI.click(findTestObject('Object Repository/Logout/input_Demo account_form-control'))
...
WebUI.click(findTestObject('Object Repository/Logout/input_Demo account_form-control_1'))
